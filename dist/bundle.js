...
var _qr_creator = __webpack_require__(1);

var qrPacked = _interopRequireWildcard(__webpack_require__(2));

var qrCodeReader = _interopRequireWildcard(__webpack_require__(3));
...
function createQRCode(fromID, cost, eventID, TTL) {
  ...
  if (isNaN(fromID) || fromID == '') {
    ...
    return; //error, no fromID specified
  }
